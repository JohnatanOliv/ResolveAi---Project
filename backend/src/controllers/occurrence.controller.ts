...
export async function create(req: AuthRequest, res: Response) {
    ...
    res.status(201).json(await occurrenceService.create(req.user!.id, { title, description, category, location, imageUrl, priority }));
}
...
export async function dashboard(_req: AuthRequest, res: Response) { res.json(await occurrenceService.dashboard()); }
